<?php 
    ...
    * 0.1 Initial version
    */
    // De versie moet gelijk zijn met het versie nummer in de my-eventorganiser.php header define( 'MY_EVENT_ORGANISER_VERSION', '0.0.1' );
    // Minimum required Wordpress version for this plugin define( 'MY_EVENT_ORGANISER_REQUIRED_WP_VERSION', '4.0' );
